#!/usr/bin/env python3
"""
Парсер che168.com для GitHub Actions
Запуск в облаке без VPN блокировок
"""
...
def parse_che168():
    ...
    print("=" * 60)
    print("ПАРСИНГ CHE168.COM ЧЕРЕЗ ПРОКСИ (GitHub Actions)")
    print("=" * 60)
...
if __name__ == '__main__':
    ...
    # Вывод для GitHub Actions output
    print(f"\n::set-output name=cars_count::{len(data['cars'])}")
    print(f"::set-output name=json_file::che168_result.json")
